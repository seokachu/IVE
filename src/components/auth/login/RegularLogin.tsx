  ...
  return (
    <>
      ...
      <div className="my-5 w-full">
        <p className="relative text-gray-300 text-center text-xs before:absolute before:w-20 before:md:w-32 before:h-[1px] before:left-0 before:bg-gray-200 before:top-2/4 before:-translate-y-2/4 after:absolute after:w-20 after:md:w-32 after:h-[1px] after:right-0 after:bg-gray-200 after:top-2/4 after:-translate-y-2/4">
          또는
        </p>
        <OAuthLogin />
      </div>
