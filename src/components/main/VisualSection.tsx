  ...
  return (
    <section className="h-[100dvh] lg:h-screen w-full relative bg-main-image bg-cover bg-center bg-no-repeat flex items-center justify-center">
      <video
        ...
        src="https://res.cloudinary.com/dknj7kdek/video/upload/f_auto,c_limit,q_auto:best/v1729614511/%E1%84%89%E1%85%B5%E1%84%8F%E1%85%AF%E1%86%AB%E1%84%89%E1%85%B3_01_iaa8xa.mp4"
        autoPlay
        muted
        loop
        playsInline
