...
import type { LatestNewsDetailProps } from "@/types";
  ...
  return (
    <article className="text-left">
      ...
      <div className="px-5 py-5">
        <p className="inline-flex px-3 py-1 rounded-full bg-purple text-white text-sm">
          {item.category}
        </p>
        <h2 className="my-5 text-xl md:text-2xl font-bold text-gray-900">
          {item.title}
        </h2>
