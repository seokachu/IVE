  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogHeader>
          <DialogTitle className="sr-only">{contentType === "news" ? "최신 소식 뉴스" : "사진 갤러리"}</DialogTitle>
          <DialogDescription className={`!m-0 ${contentType === "news" ? "max-h-[80dvh] overflow-y-auto" : ""}`}>
            {contentType === "news" ? (
